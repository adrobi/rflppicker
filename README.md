...
Скачайте архив первого релиза и запустите `RFLP-Picker.exe`. Python на
...
Готовый архив первого релиза находится в каталоге `release/` локальной копии.
Для пересборки EXE из исходников выполните `.\build_windows.ps1`; результат
появится в `dist/RFLP-Picker/`.
